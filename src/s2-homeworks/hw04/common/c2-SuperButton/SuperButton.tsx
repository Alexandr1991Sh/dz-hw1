...
const SuperButton: React.FC<SuperButtonPropsType> = (
    ...
    const finalClassName = `${s.button} ${xType === 'red' ? s.red : xType === 'secondary' ? s.secondary : s.default} ${s.disabled ? s.disabled : ''}`
        // s.button
        // + (disabled
        //         ? ...
        //         : xType === 'red'
...
// `${s.button} ${xType === 'red' ? s.red : xType === 'secondary' ? s.secondary : s.default} ${s.disabled ? s.disabled : ''}`
    return (
        <button
            disabled={disabled}
